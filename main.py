...
def showPositions():
    ...
    led.drawText("2", x=9, y=0, color=(200, 200, 200), bg=(0, 0, 0), aa=False, font='8x6', font_scale=1)
    led.drawText("3", x=17, y=0, color=(200, 200, 200), bg=(0, 0, 0), aa=False, font='8x6', font_scale=1)
    led.drawText("4", x=25, y=0, color=(200, 200, 200), bg=(0, 0, 0), aa=False, font='8x6', font_scale=1)
    led.update()
